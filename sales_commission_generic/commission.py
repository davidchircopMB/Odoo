...
class SaleCommission(models.Model):
    ...
    exception_ids = fields.One2many('sale.commission.exception', 'commission_id', string='Designer Royalties Exceptions',
...
class SaleCommissionException(models.Model):
    ...
    based_on_2 = fields.Selection([('Fix Price', 'Fix Price'),
                                   ('Margin', 'Margin'),
                                   ('Royalty Exception', 'Royalty Exception')], string="With",
                                 help="Royalty exception based on", default='Fix Price',
                                 required=True)
    ...
    commission_precentage = fields.Float(string="Royalty %")
    below_margin_commission = fields.Float(string="Below Margin Royalty %")
    above_margin_commission = fields.Float(string="Above Margin Royalty %")
    margin_percentage = fields.Float(string="Target Margin %")
    price = fields.Float(string="Target Price")
    price_percentage = fields.Float(string="Above price Royalty %")
